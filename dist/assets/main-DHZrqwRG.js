 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ug;function Np(){return Ug||(Ug=1,function(o){function c(M,q){var K=M.length;M.push(q);e:for(;0<K;){var pe=K-1>>>1,p=M[pe];if(0<h(p,q))M[pe]=q,M[K]=p,K=pe;else break e}}function d(M){return M.length===0?null:M[0]}function u(M){if(M.length===0)return null;var q=M[0],K=M.pop();if(K!==q){M[0]=K;e:for(var pe=0,p=M.length,k=p>>>1;pe<k;){var z=2*(pe+1)-1,B=M[z],Q=z+1,oe=M[Q];if(0>h(B,K))Q<p&&0>h(oe,B)?(M[pe]=oe,M[Q]=K,pe=Q):(M[pe]=B,M[z]=K,pe=z);else if(Q<p&&0>h(oe,K))M[pe]=oe,M[Q]=K,pe=Q;else break e}}return q}function h(M,q){var K=M.sortIndex-q.sortIndex;return K!==0?K:M.id-q.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var v=performance;o.unstable_now=function(){return v.now()}}else{var T=Date,w=T.now();o.unstable_now=function(){return T.now()-w}}var S=[],f=[],C=1,L=null,N=3,G=!1,x=!1,H=!1,V=!1,P=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,J=typeof setImmediate<"u"?setImmediate:null;function re(M){for(var q=d(f);q!==null;){if(q.callback===null)u(f);else if(q.startTime<=M)u(f),q.sortIndex=q.expirationTime,c(S,q);else break;q=d(f)}}function W(M){if(H=!1,re(M),!x)if(d(S)!==null)x=!0,we||(we=!0,Ge());else{var q=d(f);q!==null&&Ye(W,q.startTime-M)}}var we=!1,Te=-1,Me=5,Se=-1;function Fe(){return V?!0:!(o.unstable_now()-Se<Me)}function ct(){if(V=!1,we){var M=o.unstable_now();Se=M;var q=!0;try{e:{x=!1,H&&(H=!1,Y(Te),Te=-1),G=!0;var K=N;try{t:{for(re(M),L=d(S);L!==null&&!(L.expirationTime>M&&Fe());){var pe=L.callback;if(typeof pe=="function"){L.callback=null,N=L.priorityLevel;var p=pe(L.expirationTime<=M);if(M=o.unstable_now(),typeof p=="function"){L.callback=p,re(M),q=!0;break t}L===d(S)&&u(S),re(M)}else u(S);L=d(S)}if(L!==null)q=!0;else{var k=d(f);k!==null&&Ye(W,k.startTime-M),q=!1}}break e}finally{L=null,N=K,G=!1}q=void 0}}finally{q?Ge():we=!1}}}var Ge;if(typeof J=="function")Ge=function(){J(ct)};else if(typeof MessageChannel<"u"){var En=new MessageChannel,An=En.port2;En.port1.onmessage=ct,Ge=function(){An.postMessage(null)}}else Ge=function(){P(ct,0)};function Ye(M,q){Te=P(function(){M(o.unstable_now())},q)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(M){M.callback=null},o.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Me=0<M?Math.floor(1e3/M):5},o.unstable_getCurrentPriorityLevel=function(){return N},o.unstable_next=function(M){switch(N){case 1:case 2:case 3:var q=3;break;default:q=N}var K=N;N=q;try{return M()}finally{N=K}},o.unstable_requestPaint=function(){V=!0},o.unstable_runWithPriority=function(M,q){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var K=N;N=M;try{return q()}finally{N=K}},o.unstable_scheduleCallback=function(M,q,K){var pe=o.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?pe+K:pe):K=pe,M){case 1:var p=-1;break;case 2:p=250;break;case 5:p=1073741823;break;case 4:p=1e4;break;default:p=5e3}return p=K+p,M={id:C++,callback:q,priorityLevel:M,startTime:K,expirationTime:p,sortIndex:-1},K>pe?(M.sortIndex=K,c(f,M),d(S)===null&&M===d(f)&&(H?(Y(Te),Te=-1):H=!0,Ye(W,K-pe))):(M.sortIndex=p,c(S,M),x||G||(x=!0,we||(we=!0,Ge()))),M},o.unstable_shouldYield=Fe,o.unstable_wrapCallback=function(M){var q=N;return function(){var K=N;N=q;try{return M.apply(this,arguments)}finally{N=K}}}}(Es)),Es}var Ng;function kp(){return Ng||(Ng=1,bs.exports=Np()),bs.exports}var As={exports:{}},Qe={};/**
 * @license React
...
<hr />
<p>This comprehensive setup and deployment guide provides step-by-step instructions for setting up the Business Services Hub in development and production environments, including troubleshooting tips and best practices for maintaining a healthy deployment.</p>`}};function gv(){return ye.jsxs("div",{className:"home-container",children:[ye.jsx("h1",{children:"Welcome to the Business Services Hub Documentation"}),ye.jsx("p",{children:"Navigate through the links on the left to explore our comprehensive documentation."})]})}function hv(){const{docName:o}=mm(),[c,d]=_.useState({title:"",content:""}),[u,h]=_.useState(!0),[v,T]=_.useState(null);return _.useEffect(()=>{if(h(!0),T(null),d({title:"",content:""}),o){const w=o.replace(".html",""),S=dv[w];S?(d(S),T(null)):(T("Document not found."),d({title:"",content:""}))}h(!1)},[o]),u?ye.jsx("div",{className:"doc-message",children:"Loading document..."}):v?ye.jsx("div",{className:"doc-error",children:v}):c.content?ye.jsxs("div",{className:"doc-viewer-container",children:[ye.jsx("h1",{children:c.title}),ye.jsx("div",{dangerouslySetInnerHTML:{__html:c.content}})]}):ye.jsx("div",{className:"doc-message",children:"No content available for this document."})}function fv(){return ye.jsx(tv,{basename:"/",children:ye.jsxs("div",{className:"app-layout",children:[ye.jsxs("nav",{className:"sidebar",children:[ye.jsx("h2",{children:"Documentation"}),ye.jsxs("ul",{children:[ye.jsx("li",{children:ye.jsx(Os,{to:"/",className:({isActive:o})=>o?"active-link":"",children:"Home"})}),cv.map(o=>ye.jsx("li",{children:ye.jsx(Os,{to:o.href,className:({isActive:c})=>c?"active-link":"",children:o.name})},o.name))]})]}),ye.jsx("main",{className:"content",children:ye.jsxs(Um,{children:[ye.jsx(Ds,{path:"/",element:ye.jsx(gv,{})}),ye.jsx(Ds,{path:"/docs/:docName",element:ye.jsx(hv,{})})]})})]})})}qp.createRoot(document.getElementById("root")).render(ye.jsx(_.StrictMode,{children:ye.jsx(fv,{})}));
